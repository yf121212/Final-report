...
from drive.MyDrive.racecar.racetrack_plt import racetrack

class python_env(object):
    def __init__(self, turns, seed, plot=True):
        ...
        self.map, self.goal, self.lens, self.points, self.angles = rt.generate(plot)
    ...
    def action(self, a):
        ...
        self.car = self.kinematic(a[0][0], a[0][1])
